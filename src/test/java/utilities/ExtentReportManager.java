...
public class ExtentReportManager implements ITestListener
{
	...
	public void onStart(ITestContext testContext)
	{
		...
		sparkreporter.config().setDocumentTitle("Ecommerce Automation Report"); // We are specifying the Title of the Report
		sparkreporter.config().setReportName("Ecommerce Functional Testing");
		sparkreporter.config().setTheme(Theme.STANDARD); 
		
		extentreports = new ExtentReports();
		extentreports.attachReporter(sparkreporter);
		extentreports.setSystemInfo("Application", "Ecommerce");
